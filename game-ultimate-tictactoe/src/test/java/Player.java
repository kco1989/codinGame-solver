...
class Player {
    ...
    static Boolean isLevelOne = null;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if(isLevelOne == null){
                ...
                if(property == null){
                    isLevelOne = validActionCount == 9 && actions.get(0).ninePos == 0;
                    if (opponentAction.isValid() && isLevelOne){
                        isLevelOne = opponentAction.ninePos == 0;
                    }
                }else{
                    isLevelOne = property.equals("1");
                }
            }
            System.err.println("isLevelOne = " + isLevelOne + " validActionCount = " + validActionCount + " level = " + System.getProperty("league.level"));
            if (isLevelOne){
    ...
    private static void doLevelTwo(ProiortyAction opponentAction, List<ProiortyAction> actions,
        ...
        if (action.ninePos == 4 && grid2.get(4)[1][1] == 0){
            ProiortyAction action411 = new ProiortyAction(4, 1, 1);
            grid2.get(4)[1][1] = g_play;
            queue2.get(4).remove(action411);
            System.out.println(action411);
            return;
        }
