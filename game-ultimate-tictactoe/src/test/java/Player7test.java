...
class Player7test {
    ...
    public static final int P_CENTRE_CENTRE = 1700;        // 中心的中心
    public static final int P_CENTRE_ANGLE = 1500;         // 中心的角
    public static final int P_ANGLE_CENTRE = 1300;         // 角的中心
    public static final int P_ANGLE_ANGLE = 1100;          // 角的角
    public static final int P_SIDE_CENTRE = 900;          // 边的中心
    public static final int P_CENTRE_SIDE = 700;          // 中心的边
    public static final int P_ANGLE_SIDE = 500;           // 角的边
    public static final int P_SIDE_ANGLE = 300;           // 边的角
    public static final int P_SIDE_SIDE = 100;            // 边的边
...
//            int validActionCount = in.nextInt();
            ...
            if (opponentAction.row != -1){
                ...
                gameInfo.allValidAction.remove(opponentAction);
                checkProiorty(opponentAction, gameInfo, false);
            }
     ...
     *  检查权限
     */
    private static void checkProiorty(PriorityAction action, GameInfo gameInfo, boolean isPlay) {
        // 统计当前操作格子棋面情况
    ...
    private static void changePriority(GridSum gridSum) {
        ...
        if (gridSum.sum == G_PLAY * 2){
            ...
            gridSum.actions.forEach(item -> item.addPriority(- P_STEP * 10));
        }
    }
